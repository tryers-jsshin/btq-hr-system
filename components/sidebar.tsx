      ...
      <nav className="flex-1 space-y-1 px-3 py-4">
        {menuItems.map((item) => {
          ...
          if (item.children) {
            ...
            return (
              <Collapsible key={item.title} open={openSettings} onOpenChange={setOpenSettings}>
                <CollapsibleTrigger asChild>
                  ...
                  >
                    ...
                    <ChevronDown className={cn("h-4 w-4 transition-transform", openSettings && "rotate-180")} />
                  </Button>
                </CollapsibleTrigger>
